...
public class LoginDark extends DefaultFrameDark {
                        ...
                        for (int i = 0; i <= totalLines; i++) {
                            ...
                            if (line.equals(userNameS)) {
                                ...
                                if (line2.equals(passwordS)) {
                                    JOptionPane.showMessageDialog(null, "Login Successful.", "Travel Agency!", JOptionPane.WARNING_MESSAGE);
