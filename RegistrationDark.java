...
public class RegistrationDark extends DefaultFrameDark {
    ...
    RegistrationDark() {
        ...
        tf4.setCaretColor(Color.decode("#99F2FA"));
        c.add(tf4);
        ...
        tf5.setFont(f5);
        tf5.setForeground(Color.decode("#99F2FA"));
        tf5.setBackground(Color.decode("#2D3250"));
        tf5.setCaretColor(Color.decode("#99F2FA"));
        c.add(tf5);
