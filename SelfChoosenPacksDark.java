...
public class SelfChoosenPacksDark extends DefaultFrameDark {
    private JComboBox cb1, cb2, cb3, cb4, cb5, cb6, cb7;

    SelfChoosenPacksDark() {
        // Frame Layout
        ...
        cb1.setFont(f5);
        cb1.setForeground(Color.decode("#99F2FA"));
        cb1.setBackground(Color.decode("#222831"));
        c.add(cb1);
        ...
        label0.setForeground(Color.decode("#99F2FA"));
        label0.setFont(f4);
        c.add(label0);
        ...
        cb2.setFont(f5);
        cb2.setForeground(Color.decode("#99F2FA"));
        cb2.setBackground(Color.decode("#222831"));
        cb2.disable();
        c.add(cb2);
        ...
        cb3.setFont(f5);
        cb3.setForeground(Color.decode("#99F2FA"));
        cb3.setBackground(Color.decode("#222831"));
        c.add(cb3);
        ...
        cb4.setFont(f5);
        cb4.setForeground(Color.decode("#99F2FA"));
        cb4.setBackground(Color.decode("#222831"));
        c.add(cb4);
        ...
        cb5.setFont(f5);
        cb5.setForeground(Color.decode("#99F2FA"));
        cb5.setBackground(Color.decode("#222831"));
        cb5.disable();
        c.add(cb5);
        ...
        cb6.setFont(f5);
        cb6.setForeground(Color.decode("#99F2FA"));
        cb6.setBackground(Color.decode("#222831"));
        cb6.disable();
        c.add(cb6);
        ...
        cb7.setFont(f5);
        cb7.setForeground(Color.decode("#99F2FA"));
        cb7.setBackground(Color.decode("#222831"));
        cb7.disable();
        c.add(cb7);
